...
@router.get("/")
def find_resources(query: str, department: str = None, top_k: int = 3, threshold: float = 0.3):
    ...
    for idx in top_indices:
        ...
        if department and department.lower() not in course.get("department", "").lower():
            continue
        ...
        if similarity >= threshold:
            results.append({
                ...
                "match_reason": f"Matched on query: '{query}'",
